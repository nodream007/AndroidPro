	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = listContainer.inflate(
					R.layout.med_send_medicine_grid, null);
			...
			listItemView.subBtn = (LinearLayout) convertView
					.findViewById(R.id.medicine_sub_id);
		...
		listItemView.linear.setTag(position);
		boolean selectedFlag = sendMedicineData.getSelected();
		if (selectedFlag) {
			listItemView.medicineNameBtn
					.setBackgroundResource(R.drawable.send_med_name_bg_selected);
		} else {
			listItemView.medicineNameBtn
