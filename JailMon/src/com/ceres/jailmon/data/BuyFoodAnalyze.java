...
public class BuyFoodAnalyze {
	private final static String TAG = "BuyFoodAnalyze";

	public static List<BuyShopping> getBuyFood(InputStream inStream,
		...
		while (event != XmlPullParser.END_DOCUMENT) {
			...
			case XmlPullParser.START_TAG:
				if ("food".equals(pullParser.getName())) {
