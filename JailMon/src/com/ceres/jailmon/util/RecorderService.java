...
import com.ceres.jailmon.RecordActivity;
...
//            }
            ...
            try {
                ...
                sendErrorBroadcast(RecordUtil.INTERNAL_ERROR);
                mRecorder.reset();
                mRecorder.release();
                mRecorder = null;
                return;
            ...
            try {
                ...
                if (isInCall) {
                    sendErrorBroadcast(RecordUtil.IN_CALL_RECORD_ERROR);
                } else {
                    sendErrorBroadcast(RecordUtil.INTERNAL_ERROR);
                }
                mRecorder.reset();
	...
	private void showRecordingNotification() {
        ...
        pendingIntent = PendingIntent
                .getActivity(this, 0, new Intent(this, RecordActivity.class), 0);
