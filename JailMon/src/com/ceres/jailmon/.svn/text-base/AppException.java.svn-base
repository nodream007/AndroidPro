/*
 * Description: Costomized exception process
 * 
...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	public final static byte TYPE_FILENOTFOUND = 0x08;
	...
	public static AppException filenotfound(Exception e) {
